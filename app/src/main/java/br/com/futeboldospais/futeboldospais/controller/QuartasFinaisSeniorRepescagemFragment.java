...
public class QuartasFinaisSeniorRepescagemFragment extends Fragment{
     ...
     */
    private static QuartasFinaisSeniorRepescagemFragment fragment = null;

    public static QuartasFinaisSeniorRepescagemFragment newInstance() {
        if (fragment == null) {
            fragment = new QuartasFinaisSeniorRepescagemFragment();
        }

        return fragment;
    }

    public QuartasFinaisSeniorRepescagemFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_quartas_finais_senior_repescagem, container, false);
        ...
        tabela = (ListView) view.findViewById(R.id.quartas_tabela_senior_repescagem);

        lista_quartas = quartasFinaisService.listarQuartasPorCategoriaGrupo(getActivity()
                .getBaseContext(), getString(R.string.str_senior_minuscula), getString(R.string.str_repescagem_minuscula));
