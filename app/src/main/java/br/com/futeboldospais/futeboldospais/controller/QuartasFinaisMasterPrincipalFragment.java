...
public class QuartasFinaisMasterPrincipalFragment extends Fragment{
     ...
     */
    private static QuartasFinaisMasterPrincipalFragment fragment = null;

    public static QuartasFinaisMasterPrincipalFragment newInstance() {
        if (fragment == null) {
            fragment = new QuartasFinaisMasterPrincipalFragment();
        }

        return fragment;
    }

    public QuartasFinaisMasterPrincipalFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_quartas_finais_master_principal, container, false);
        ...
        tabela = (ListView) view.findViewById(R.id.quartas_tabela_master_principal);

        lista_quartas = quartasFinaisService.listarQuartasPorCategoriaGrupo(getActivity()
                .getBaseContext(), getString(
                        R.string.str_master_minuscula), getString(R.string.str_principal_minuscula));
